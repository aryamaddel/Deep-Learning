...
# Keep spatial dims for CNN: (N, 1, 28, 28)
...
print("Training Simple CNN (2 conv + BN + DO, full 60k, 12 epochs)...")
t0 = time.time()
...
path = save_result("7. Simple CNN", acc, prec, rec, f1, t_train, t_infer, cm)
print_results("7. Simple CNN", acc, f1, t_train, t_infer)
