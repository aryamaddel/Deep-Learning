...
print("Training Random Forest on 15k stratified samples...")
t0 = time.time()
model = RandomForestClassifier(n_estimators=500, max_depth=30, n_jobs=-1, random_state=42)
...
path = save_result("2. Random Forest", acc, prec, rec, f1, t_train, t_infer, cm)
print_results("2. Random Forest", acc, f1, t_train, t_infer)
