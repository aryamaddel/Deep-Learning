...
model = MLP2Layer().to(device)
criterion = nn.CrossEntropyLoss()
optimizer = optim.Adam(model.parameters(), lr=1e-3)

print("Training 2-Layer MLP (full 60k, 10 epochs)...")
t0 = time.time()
...
path = save_result("6. 2-Layer MLP", acc, prec, rec, f1, t_train, t_infer, cm)
print_results("6. 2-Layer MLP", acc, f1, t_train, t_infer)
